...
-Customer Selection: a dropdown menu populated with static values to facilitate the selection of customers.

-Product Search and Addition: a search bar on the POS screen, to search products. Selected products should be added to the transaction.

-Discount Application: option to apply discounts to the transaction.
